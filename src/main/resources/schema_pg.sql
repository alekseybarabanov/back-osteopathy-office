...
create table visit (
     ...
     region_brest_struct_details TEXT,
     region_brest_vistz integer,
     region_cr integer,
     region_dura_mater_struct integer,
     region_hands_right_struct integer,
     region_hands_left_struct integer,
     region_head_struct integer,
     region_legs_right_struct integer,
     region_legs_left_struct integer,
     region_lower_back_struct integer,
     region_lower_back_struct_details TEXT,
